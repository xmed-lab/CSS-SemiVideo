...
from . import seg_cycle
from . import video_segin
from . import vidsegin_teachstd_kd
...
def loadvideo(filename: str) -> np.ndarray:
    ...
    ###debug
    # print(datetime.datetime.now().strftime("%Y%m%d_%H%M%S"), "opening vid")
    capture = cv2.VideoCapture(filename)
    # print(datetime.datetime.now().strftime("%Y%m%d_%H%M%S"), "videocapture done")
    ...
    # print(datetime.datetime.now().strftime("%Y%m%d_%H%M%S"), "reading capture")
    ...
    # print(datetime.datetime.now().strftime("%Y%m%d_%H%M%S"), "finished opening vid")
...
__all__ = ["video", "segmentation", "seg_ctrmlt", "seg_sslflw", "vidseg", "seg_cycle", "vidsegin_iekd_att", "vidseg_iekd_att_mult", "vidseg_iekd_att_mult_reg", "vidsegin_iekd_att_reg", "video_segin", "vidseg_iekd_att", "video_seginsegonly", "video_segin_hallucinate", "videossl", "loadvideo", "savevideo", "get_mean_and_std", "bootstrap", "latexify", "dice_similarity_coefficient", "vidseg_iekd_ftchck"]
